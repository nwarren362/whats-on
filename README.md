...
- Add a desktop bookmarklet that captures the current page and opens a Paper.li-style review window.
...
- Allow approved research items to be added from a Codex conversation through a private authenticated tool.
